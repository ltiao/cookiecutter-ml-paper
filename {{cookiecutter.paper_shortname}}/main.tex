...
\newcommand{\crefsupp}[1]{\cref{supp:#1} of the supplemental material}
...
\subsection{Referencing the Supplemental Material}

For example, we can refer the reader to \crefsupp{sub:experiments_on_dataset_a}.
